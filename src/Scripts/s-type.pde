...
void setup(){
  ...
  planets[0] = new MassPoint(new Vector(0,0,-149600000000.0), new Vector(0,-15000,0), 1.989*pow(10,30), 0);
  planets[1] = new MassPoint(new Vector(0,0,  90000000000.0), new Vector(0,60000,0),5.9723*pow(10,24),1);
  planets[2] = new MassPoint(new Vector(0,0, 149600000000.0), new Vector(0,15000,0), 1.989*pow(10,30),2);
